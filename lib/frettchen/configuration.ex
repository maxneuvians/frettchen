defmodule Frettchen.Configuration do
  ...
  ## Examples
    ...
    %Frettchen.Configuration{agent_host: "localhost", agent_port: 6832, collector_host: "localhost", collector_port: 14268, http_options: [], local_udp_port: 16667, reporter: :remote, target: :agent}
  """
